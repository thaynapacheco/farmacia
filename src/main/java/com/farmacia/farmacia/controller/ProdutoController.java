...
public class ProdutoController {
	...
	private ResponseEntity<List<Produto>>getByItem(@PathVariable String item){
	...
	public ResponseEntity<List<Produto>>getByPreco(@PathVariable BigDecimal inicio,@PathVariable BigDecimal fim){
